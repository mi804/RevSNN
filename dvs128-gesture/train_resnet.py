...
import model, utils, revmodel, ms_resnet, revs_resnet
...
def parse_args():
    ...
    parser.add_argument('--model', default='ms_resnet20', help='model')
    ...
    parser.add_argument('--data-path', default='/home/hongzhang/data/datasets/DVS/DVSGesture', help='dataset')
...
def main(args):
    ...
    if args.model in ms_resnet.__dict__:
        model = ms_resnet.__dict__[args.model](T=4, num_classes=args.num_classes)
    elif args.model in revs_resnet.__dict__:
        model = revs_resnet.__dict__[args.model](T=4, enable_amp=args.amp, num_classes=args.num_classes)
    else:
