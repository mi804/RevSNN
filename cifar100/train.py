...
parser.add_argument('-data-dir', metavar='DIR',default="/home/hongzhang/data/datasets/classification/cifar/cifar100",
...
def main():
    ...
    model = create_model(
        ...
        depths=args.depths, sr_ratios=1,enable_amp=args.amp
    )
    ...
    if args.distributed:
        if has_apex and use_amp != 'native':
            ...
            model = NativeDDP(model, device_ids=[args.local_rank], find_unused_parameters=find_unused_parameters)   # can use device str in Torch >= 1.1
