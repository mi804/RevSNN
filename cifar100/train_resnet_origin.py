...
import ms_resnet, utils, revs_resnet
...
def main(args):
    ...
    if args.model in ms_resnet.__dict__:
        ...
        model = revs_resnet.__dict__[args.model](T=args.T, enable_amp=args.amp)
    else:
...
def parse_args():
    ...
    parser.add_argument('--data-path', default='/home/hongzhang/data/datasets/classification/cifar/cifar100', help='dataset')

    parser.add_argument('--model', default='ms_resnet10', help='model')
